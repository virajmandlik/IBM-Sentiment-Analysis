...
// import ibmCloudStorage from "../assets/ibmCloudStorage.png";
// import ibmAnalytics from "../assets/ibmAnalytics.png";
// import ibmSecurity from "../assets/ibmSecurity.png";
...
export function OrbitingCirclesDemo() {
  return (
    <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-lg bg-background md:shadow-xl">
      {/* BorderBeam effect */}
      <BorderBeam size={350} duration={8} delay={4} />

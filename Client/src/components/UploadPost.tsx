...
const Iphone15ProDemo: React.FC = () => {
  ...
  const handlePost = async () => {
    ...
    try {
      const response = await fetch("https://ibm-sentiment-analysis.vercel.app/api/instagram/post", {
        method: "POST",
  ...
  const handleCheckSentiment = async () => {
    ...
    try {
      const response = await fetch("https://ibm-sentiment-analysis.vercel.app/api/predict", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
